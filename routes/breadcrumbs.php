...
Breadcrumbs::for('sales', function (BreadcrumbTrail $trail) {
    $trail->parent('dashboard');
    $trail->push(trans('sales::app.layouts.sales'), route('admin.sales.dashboard.index'));
});

// Dashboard > Sales > Dashboard
Breadcrumbs::for('sales.dashboard', function (BreadcrumbTrail $trail) {
    $trail->parent('sales');
    $trail->push(trans('sales::app.dashboard.title'), route('admin.sales.dashboard.index'));
});

// Dashboard > Sales > Targets
Breadcrumbs::for('sales.targets', function (BreadcrumbTrail $trail) {
    $trail->parent('sales');
    $trail->push(trans('sales::app.targets.title'), route('admin.sales.targets.index'));
});

// Dashboard > Sales > Targets > Create
Breadcrumbs::for('sales.targets.create', function (BreadcrumbTrail $trail) {
    $trail->parent('sales.targets');
    $trail->push(trans('sales::app.targets.create-title'), route('admin.sales.targets.create'));
});

// Dashboard > Sales > Targets > Edit
Breadcrumbs::for('sales.targets.edit', function (BreadcrumbTrail $trail, $target) {
    $trail->parent('sales.targets');
    $trail->push(trans('sales::app.targets.edit-title'), route('admin.sales.targets.edit', $target->id));
});

// Dashboard > Sales > Performance
Breadcrumbs::for('sales.performance', function (BreadcrumbTrail $trail) {
    $trail->parent('sales');
    $trail->push(trans('sales::app.performance.title'), route('admin.sales.performance.index'));
});
...
Breadcrumbs::for('sales.reports', function (BreadcrumbTrail $trail) {
    $trail->parent('sales');
    $trail->push(trans('sales::app.reports.title'), route('admin.sales.reports.index'));
});

// Dashboard > Sales > Reports > Create
Breadcrumbs::for('sales.reports.create', function (BreadcrumbTrail $trail) {
    $trail->parent('sales.reports');
    $trail->push(trans('sales::app.reports.create-title'), route('admin.sales.reports.create'));
});

// Dashboard > Sales > Reports > View
Breadcrumbs::for('sales.reports.view', function (BreadcrumbTrail $trail, $report) {
    $trail->parent('sales.reports');
    $trail->push($report->name, route('admin.sales.reports.view', $report->id));
});
